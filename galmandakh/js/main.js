$(function() {
  ...
  const I18N = {
    mn: {
      ...
      'about.desc': 'Backend, frontend хоёуланг хамарсан full-stack хөгжүүлэгч. Даатгал, төлбөр, POS зэрэг бодит үйл ажиллагаанд ашиглагддаг, төлбөрийн гүйлгээтэй системийг эхнээс нь дуустал бүтээсэн, мөн production дээр ажиллаж байгаа системд шинэ модуль нэмж хүргэсэн туршлагатай. Next.js, Laravel, Node.js, Flutter.<br><br>Шинэ домэйн, шинэ технологийн стекийг хурдан эзэмшиж, ажлаа хэрэглэгчид хүрэх хүртэл хөтөлж дуусгадаг. Тодорхой бус асуудлыг задлан шинжиж шийдэл гаргах, шинэ санааг бүтээгдэхүүн болгож хэрэгжүүлэх нь миний ажиллах арга барил.<br><br>Хиймэл оюун ухааны инженер болох зорилготой. AI хэрэгслүүдийг өдөр тутмын хөгжүүлэлтдээ аль хэдийн ашигладаг бөгөөд дараагийн алхам нь модель бүтээж, хиймэл оюун ухааныг өөрөө хөгжүүлэх талд гүнзгийрэх юм.',
      'about.p1': 'Хурдан сурч',
      'about.p2': 'Шинэ санаа, тодорхой шийдэл',
      'about.p3': 'Хиймэл оюун ухаан · дизайн',
    ...
    en: {
      ...
      'about.desc': 'Full-stack developer covering both backend and frontend. Experienced in building payment-backed systems used in real operations — insurance, payments, POS — from scratch through to live, and in shipping new modules onto systems already in production. Next.js, Laravel, Node.js, Flutter.<br><br>I pick up a new domain or technology stack quickly and stay with the work until it reaches users. Breaking an unclear problem down, finding a solution, and turning a new idea into a product is how I work.<br><br>I aim to become an AI engineer. I already use AI tools in daily development; the next step is building models and going deeper into developing AI myself.',
      'about.p1': 'Learn fast',
      'about.p2': 'New ideas, concrete solutions',
      'about.p3': 'Artificial intelligence · design',
